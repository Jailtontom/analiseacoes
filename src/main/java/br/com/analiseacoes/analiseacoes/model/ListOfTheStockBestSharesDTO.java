...
public class ListOfTheStockBestSharesDTO implements Serializable, Comparable<ListOfTheStockBestSharesDTO> {
	...
	@Override
	public int compareTo(ListOfTheStockBestSharesDTO lotsbs) {
